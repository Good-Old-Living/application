...
public class AccountManager {
  ...
  public AccountManager(AppContext appContext, AppEngine appEngine, ServiceManager serviceManager) {
  ...
  User createUser(String name, String email, String roleId, String provider, String providerId) {
    email = email.trim();
    User user = new User();
...
//    appEngine.save(user);
  ...
  User createMobileUser(String mobileNo, String password, Role role) {
  ...
  public AuthToken authenticate(String userName, String password) {
    ...
    return new AuthToken(uidGenerator.getUId(), user.getMobile(), (info == null) ? String.valueOf(user.getId()) : info,
        user.getPrimaryRole().getHome());
  }

  public AuthToken authenticateByProvider(String name, String email, String provider, String providerId) {
    email = email.trim();
    ...
    if (email != null) {
      ...
      throw new AppException("Invalid login request [" + email + ", " + provider + ", " + providerId + "]");
    }
  ...
  public AuthToken otpLogin(String mobileNo, String otp) {
    mobileNo = checkMobileNumber(mobileNo);
    User user = getUserByMobile(mobileNo);
...
//      }
    ...
    if (user.getPassword().equals(encOtp)) {
      ...
      return new AuthToken(uidGenerator.getUId(), user.getMobile(),
  ...
  private User getUserByProvider(String provider, String providerId) {
  ...
  public NewUser createTempNewUser(String userName, String email, String mobile, String password, String roleId) {
...
//      user.setEmailAccessToken(uidGenerator.getUId());
    ...
    if (StringHelper.isNullOrEmpty(userId) || StringHelper.isNullOrEmpty(password)) {
...
//    user.setRegisteredOn(systemCalendar.getUTCCalendar());
  ...
  public void resetPassword(String email) {
    ...
    String template = IOSystem.read(
        appContext.getInputStream(SecurityAppProperty.TEMPLATE_DIR_MAIL + "ResetPassword.html"));
